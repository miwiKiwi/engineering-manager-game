  ...
  backend: [
    {
      ...
      options: [
        { text: 'Dockeryzacja - stawiamy kontener.', effects: { sanity: -3, morale: -5, codeQuality: 0 } },
        { text: 'Fixuj lokalnie, niech działa.', effects: { sanity: -5, morale: 5, codeQuality: -10 } },
        { text: 'Badź poważny, przepisz od zera.', effects: { sanity: -5, morale: -10, codeQuality: 10 } },
      ],
    },
    {
      id: 'be2',
    ...
    },
    {
      ...
      options: [
        { text: 'Stało się, idź dalej', effects: { sanity: 0, morale: 5, codeQuality: -5 } },
        { text: 'Dodajemy linting rules', effects: { sanity: -5, morale: -5, codeQuality: 5 } },
        { text: '*głębokie westchnienie*', effects: { sanity: 1, morale: 0, codeQuality: 0 } },
      ],
    },
    {
      id: 'be4',
      ...
      options: [
        { text: 'Okej, ale przekaż taski.', effects: { sanity: -5, morale: 5, codeQuality: -5 } },
        { text: 'Nie możesz teraz.', effects: { sanity: -3, morale: -20, codeQuality: 0 } },
        { text: 'Bierz, odpoczynek jest ważny. Jakoś sobie poradzimy.', effects: { sanity: -7, morale: 15, codeQuality: -10 } },
      ],
    },
    {
      id: 'be5',
      ...
      options: [
        { text: 'To bug. Napraw.', effects: { sanity: -6, morale: -10, codeQuality: 5 } },
        { text: 'Known limitation, dokumentujemy i już.', effects: { sanity: -5, morale: 5, codeQuality: -10 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '3 bazy mówisz? Code review i refactoring.', effects: { sanity: -8, morale: -5, codeQuality: 5 } },
      ],
    },
    {
      id: 'be8',
      ...
      options: [
        { text: 'Migrujemy testy do nowej wersji, bez dyskusji', effects: { sanity: -5, morale: -10, codeQuality: 5 } },
        { text: 'Piszemy nowe, lepsze testy', effects: { sanity: -8, morale: -5, codeQuality: 10 } },
        { text: '12% to wystarczy... wywal te stare...', effects: { sanity: -10, morale: 5, codeQuality: -15 } },
      ],
    },
    {
      id: 'be6',
      ...
      options: [
        ...
        { text: 'Ciekawe, ATLAS... sprawdzę to później w konsoli...', effects: { sanity: 10, morale: 0, codeQuality: 0 } },
        { text: 'Usuń to, nie potrzebujemy tajemnic.', effects: { sanity: -20, morale: 0, codeQuality: 5 } },
      ],
    },
  ],
  frontend: [
    {
      ...
      options: [
        ...
        { text: 'Dobra, zostawcie tą Sagę skoro już jest...', effects: { sanity: -10, morale: 5, codeQuality: -20 } },
      ],
    },
    {
      id: 'fe2',
      ...
      options: [
        ...
        { text: 'Przepisz normalnie', effects: { sanity: -3, morale: -10, codeQuality: 10 } },
        { text: 'Code review i wyjaśnienie', effects: { sanity: -6, morale: -5, codeQuality: 5 } },
      ],
    },
    {
      id: 'fe3',
      ...
      options: [
        { text: 'Fix dla Safari.', effects: { sanity: -6, morale: -5, codeQuality: 5 } },
    ...
    },
    {
      ...
      options: [
        { text: 'Code splitting i lazy loading, to nie może tak działać.', effects: { sanity: -8, morale: -10, codeQuality: 10 } },
        { text: 'Dodajemy ładny loading spinner z samolotem, bedzie im lepiej', effects: { sanity: -2, morale: 5, codeQuality: -10 } },
        { text: 'Optymalizujemy importy, zawsze coś.', effects: { sanity: -5, morale: -5, codeQuality: 5 } },
      ],
    },
    {
      id: 'fe8',
      ...
      options: [
        { text: 'Przejrzymy je i usuniemy nieużywane.', effects: { sanity: -6, morale: -10, codeQuality: 5 } },
        { text: 'Zostaw, może się przydadzą.', effects: { sanity: -2, morale: 5, codeQuality: -10 } },
        { text: 'Design system od zera, zaczynamy.', effects: { sanity: -12, morale: -15, codeQuality: 10 } },
      ],
    },
    {
      id: 'fe6',
      ...
      options: [
        ...
        { text: 'Pokaż mi to...', effects: { sanity: -2, morale: 0, codeQuality: 0 } },
        { text: 'Awareness test? Ciekawe... Nigdzie w kodzie tego nie ma?', effects: { sanity: 5, morale: 0, codeQuality: 0 } },
      ],
    },
  ],
  devops: [
    {
      ...
      options: [
        { text: 'Debugujemy i szukamy root cause.', effects: { sanity: -10, morale: -10, codeQuality: 10 } },
        { text: 'Workaround z restartami i stwórz taska na analizę.', effects: { sanity: -3, morale: 5, codeQuality: -10 } },
        { text: 'Skalujemy horyzontalnie, więcej nodów, wyłączcie alerty.', effects: { sanity: -5, morale: -5, codeQuality: -15 } },
      ],
    },
    {
      id: 'do2',
      ...
      options: [
        { text: 'Przepisujemy pipeline od zera.', effects: { sanity: -10, morale: -15, codeQuality: 10 } },
        { text: 'Dodajemy retry i idziemy na lunch.', effects: { sanity: -4, morale: 5, codeQuality: -10 } },
        { text: 'Migracja na GitHub Actions.', effects: { sanity: -8, morale: 0, codeQuality: 5 } },
      ],
    },
    {
      id: 'do3',
      ...
      options: [
        { text: 'Naprawiamy monitoring i zobaczymy czy to prawda.', effects: { sanity: -6, morale: -5, codeQuality: 5 } },
    ...
    },
    {
      ...
      options: [
        { text: 'Rebuild state ręcznie. Trzeba było pilnować.', effects: { sanity: -15, morale: -15, codeQuality: -10 } },
        { text: 'Importujemy istniejące resource-y', effects: { sanity: -8, morale: -5, codeQuality: -5 } },
        { text: 'Restore z backupu sprzed release-a', effects: { sanity: 0, morale: 5, codeQuality: -5 } },
      ],
    },
    {
      id: 'do5',
      ...
      options: [
        { text: 'Cleanup policy + kasujemy stare.', effects: { sanity: -6, morale: -5, codeQuality: 5 } },
    ...
    },
    {
      ...
      options: [
        { text: 'Restore z backupu, lekcja na przyszłość.', effects: { sanity: -10, morale: -5, codeQuality: 0 } },
        { text: 'RBAC i ograniczamy uprawnienia. Tak, Tobie też.', effects: { sanity: -8, morale: -15, codeQuality: 10 } },
        { text: '*długie, wymowne milczenie*', effects: { sanity: -5, morale: -10, codeQuality: -5 } },
      ],
    },
    {
      id: 'do8',
      ...
      options: [
        ...
        { text: 'Vault setup + git-secrets hook.', effects: { sanity: -8, morale: -5, codeQuality: 5 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: 'I nie ma 404? Interesujące... zbadajmy to.', effects: { sanity: 5, morale: 0, codeQuality: 0 } },
        { text: 'Ignorujemy, pewnie bot.', effects: { sanity: -5, morale: 0, codeQuality: 0 } },
      ],
    },
  ],
  po: [
    {
      ...
      options: [
        ...
        { text: 'Kompromis - część teraz, część potem.', effects: { sanity: -4, morale: -5, codeQuality: -5 } },
      ],
    },
    {
      id: 'po2',
      ...
      options: [
        ...
        { text: 'Ignorujemy nowe OKR-y, dowieziemy to co jest.', effects: { sanity: -3, morale: 10, codeQuality: -5 } },
      ],
    },
    {
      id: 'po3',
      ...
      options: [
        ...
        { text: 'Niech odchodzi, ten feature zajmie 5 sprint-ów.', effects: { sanity: -4, morale: 5, codeQuality: 5 } },
      ],
    },
    {
      id: 'po4',
      ...
      options: [
        ...
        { text: 'Robimy lepszą wersję, spokojnie.', effects: { sanity: -4, morale: 5, codeQuality: 5 } },
    ...
    },
    {
      ...
      options: [
        { text: 'Blokujemy zmiany do końca sprintu.', effects: { sanity: -8, morale: 10, codeQuality: 5 } },
        { text: 'Okej, zmieniamy, ale przynieś zespołowi ciasto za tydzień.', effects: { sanity: -10, morale: -10, codeQuality: -10 } },
        { text: 'Spotkanie z zarządem - ustalamy raz i tyle.', effects: { sanity: -8, morale: -5, codeQuality: 5 } },
      ],
    },
    {
      id: 'po7',
      text: '"Mam 36 user stories w backlogu. Wszystkie oznaczone jako P0. Które robimy pierwsze?"',
      options: [
        { text: 'Priorytetyzujemy razem, max 5 P0', effects: { sanity: -6, morale: 5, codeQuality: 5 } },
        { text: 'Robimy wszystkie naraz, i tak się opóźnią.', effects: { sanity: -8, morale: -20, codeQuality: -15 } },
        { text: 'Losujemy. Serio. Chcesz ktorymś obniżyć priorytet?', effects: { sanity: -3, morale: 0, codeQuality: -10 } },
      ],
    },
  ],
  junior: [
    ...
    },
    {
      ...
      options: [
        { text: 'Konstruktywny feedback 1:1.', effects: { sanity: -8, morale: 10, codeQuality: 5 } },
        { text: 'Szczery ale ostry feedback.', effects: { sanity: -4, morale: -10, codeQuality: 5 } },
    ...
    },
    {
      ...
      options: [
        { text: 'Pair programming session, wykminicie to.', effects: { sanity: -8, morale: 10, codeQuality: 5 } },
        { text: 'Tu masz guavę, robi to samo i ma dokumentację.', effects: { sanity: -8, morale: -5, codeQuality: 5 } },
    ...
    },
    {
      ...
      options: [
        { text: 'Review razem ze mną: "Jak poznać, że to szajs?"', effects: { sanity: -8, morale: 0, codeQuality: 5 } },
        { text: 'Użyj sprawdzonej alternatywy, takich starych rzeczy sie nie używa.', effects: { sanity: -4, morale: -5, codeQuality: 5 } },
        { text: 'Okej, eksperymentuj, ale security issues bedą na ciebie.', effects: { sanity: -3, morale: 5, codeQuality: -10 } },
      ],
    },
    {
      id: 'jr5',
    ...
    },
    {
      ...
      options: [
        { text: 'Reflog i przywracamy, spokojnie. Ale nie rób tak więcej.', effects: { sanity: -6, morale: 5, codeQuality: 0 } },
        { text: 'Branch protection rules, teraz, devops!', effects: { sanity: -5, morale: -10, codeQuality: 5 } },
        { text: 'Jak... jak to w ogóle możliwe, że nie wiedziałeś?', effects: { sanity: -12, morale: -5, codeQuality: -5 } },
      ],
    },
    {
      id: 'jr8',
